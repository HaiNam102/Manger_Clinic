            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-4 bg-dark-900/50 rounded-xl border border-dark-800">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center justify-between">
                            <h3 className="text-xl font-bold text-dark-50">{patient.fullName}</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        <h4 className="text-sm font-semibold text-dark-300 uppercase tracking-wider">Thông tin liên lạc</h4>
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3 text-dark-200">
                                ...
                                <div className="text-sm">
                                    <p className="text-dark-400 text-xs">Địa chỉ</p>
                    ...
                    <div className="space-y-4">
                        <h4 className="text-sm font-semibold text-dark-300 uppercase tracking-wider">Thông tin y tế</h4>
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="flex flex-wrap gap-1">
                                    {patient.allergies && patient.allergies.length > 0 ? (
                                        ...
                                        <span className="text-dark-500 italic text-sm">Không có dữ liệu</span>
                                    )}
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                <p className="text-dark-400 text-xs mb-1">Liên hệ khẩn cấp</p>
