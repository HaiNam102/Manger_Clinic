            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-4 bg-dark-900/50 rounded-xl border border-dark-800">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center justify-between">
                            <h3 className="text-xl font-bold text-dark-50">{doctor.fullName}</h3>
                        ...
                        <div className="flex items-center gap-4 mt-3 text-sm text-dark-400">
                            <div className="flex items-center gap-1">
                                ...
                                <span className="font-bold text-dark-100">{doctor.avgRating?.toFixed(1) || '0.0'}</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        <h4 className="text-sm font-semibold text-dark-300 uppercase tracking-wider">Thông tin liên hệ</h4>
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3 text-dark-200">
                                ...
                                <div className="text-sm">
                                    <p className="text-dark-400 text-xs">Số điện thoại</p>
                            ...
                            <div className="flex items-center gap-3 text-dark-200">
                                ...
                                <div className="text-sm">
                                    <p className="text-dark-400 text-xs">Số giấy phép</p>
                    ...
                    <div className="space-y-4">
                        <h4 className="text-sm font-semibold text-dark-300 uppercase tracking-wider">Học vấn & Chứng chỉ</h4>
                        <div className="space-y-4">
                            <div>
                                <p className="text-dark-400 text-xs flex items-center gap-1 mb-2">
                                    <BookOpen size={12} /> Bằng cấp
                                </p>
                                <ul className="list-disc list-inside text-sm text-dark-200 space-y-1">
                                    {doctor.education && doctor.education.length > 0 ? (
                                        doctor.education.map((edu, idx) => <li key={idx}>{edu}</li>)
                                    ) : (
                                        <li className="text-dark-500 italic">Chưa cập nhật</li>
                                    )}
                                </ul>
                            </div>
                            <div>
                ...
                <div className="space-y-2">
                    <h4 className="text-sm font-semibold text-dark-300 uppercase tracking-wider">Giới thiệu</h4>
                    <div className="p-4 bg-dark-900/30 rounded-lg border border-dark-800 text-sm text-dark-200 leading-relaxed whitespace-pre-wrap">
                        {doctor.bio || 'Chưa có thông tin giới thiệu.'}
                    </div>
                </div>

                <div className="flex justify-end pt-4 border-t border-dark-800 gap-2">
